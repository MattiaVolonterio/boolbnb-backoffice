<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Una volta che il tuo account sarà eliminato, tutte le sue risorse e dati saranno permanentemente eliminati. Prima dell'eliminazione assicurati di scaricare tutte le informazioni che desideri conservare.") }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __("Una volta che il tuo account sarà eliminato, tutte le sue risorse e dati saranno permanentemente eliminati. Inserisci la password per confermare l'eliminazione") }}
                    </p>
                </div>
